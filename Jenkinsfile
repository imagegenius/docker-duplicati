    ...
    stage('Build-Single') {
      ...
      steps {
        ...
        sh "docker build \
          ...
          --label \"org.opencontainers.image.url=https://github.com/hydazz/docker-duplicati/packages\" \
          --label \"org.opencontainers.image.source=https://github.com/hydazz/docker-duplicati\" \
